...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAMUI",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAMUI-1.0.0-beta+20230303092649.xcframework.zip",
			checksum: "196a7ee08708dfc590c1fdceba87753c0a740a12db7acb5c759e256cde8eaaa9"
		)
	]
)