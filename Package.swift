...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAMUI",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAMUI-1.0.0-beta+20230509131236.xcframework.zip",
			checksum: "5bdc89fae9ccf9a56e89f58e08500da2b240746d3e800cfb59d282cec463689e"
		)
	]
)