...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAMUI",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAMUI-1.0.0-beta+20230601044120.xcframework.zip",
			checksum: "c37b791a28adb272ebe3fdae1a9c493dc6ccccda8c6c7f932d6d4d2309297a95"
		)
	]
)