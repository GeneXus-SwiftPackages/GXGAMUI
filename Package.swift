...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAMUI",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAMUI-1.0.0-beta+20230525135158.xcframework.zip",
			checksum: "6ccf6e72fb8277ff876f72c560f82f616520bcd67d904d01bc3c884b67903ae4"
		)
	]
)