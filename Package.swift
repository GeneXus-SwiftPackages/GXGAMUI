...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXGAM.git", exact: "1.0.0-beta.20230704143346"),
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAMUI",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAMUI-1.0.0-beta.20230704143346.xcframework.zip",
			checksum: "462ff9bbeebee4c8eb021aac22a9c36cfd63ca0a5fed17b7fdfa8d1ef72a5ad6"
		)
	]
)