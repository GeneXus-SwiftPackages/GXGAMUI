...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXGAM.git", exact: "1.1.0-rc.3"),
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAMUI",
			url: "https://pkgs.genexus.dev/iOS/preview/GXGAMUI-1.1.0-rc.3.xcframework.zip",
			checksum: "4a934e2ca91d420168d19200a9cbe6b8031e37a04240cd17393f5434bdee6522"
		)
	]
)