...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXGAM.git", exact: "1.1.0-rc.1"),
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAMUI",
			url: "https://pkgs.genexus.dev/iOS/releases/GXGAMUI-1.1.0-rc.1.xcframework.zip",
			checksum: "37d8b99ed416a51ba93f87d1057734e21ba9fcc747753ef7c9fa6e59e9cf4156"
		)
	]
)