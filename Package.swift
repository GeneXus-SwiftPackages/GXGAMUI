...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAMUI",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAMUI-1.0.0-beta+20230515145153.xcframework.zip",
			checksum: "a78f8d9f1667ef4a86eed058a7c533b113e649971bdcfcebef3373f93b2aabd6"
		)
	]
)