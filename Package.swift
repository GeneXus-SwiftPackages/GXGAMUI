...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAMUI",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAMUI-1.0.0-beta+20230503131704.xcframework.zip",
			checksum: "d5e523320687952674ba8d9ccb59e6bc7090e715f6bd7e82c2d2ef814f385441"
		)
	]
)