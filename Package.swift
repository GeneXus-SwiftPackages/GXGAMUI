...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXGAM.git", exact: "1.0.0-beta.20230710220444"),
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAMUI",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAMUI-1.0.0-beta.20230710220444.xcframework.zip",
			checksum: "b246098847a2ec582734f6df445c2588f80e42875543ce05ceef3ef32cc43498"
		)
	]
)