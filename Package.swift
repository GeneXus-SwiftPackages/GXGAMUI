...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAMUI",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAMUI-1.0.0-beta+20230306105223.xcframework.zip",
			checksum: "c3ad6f20a223ae2f778f8cfc810009c9a1c0b5ba6cae73bbf558a19e22d9e785"
		)
	]
)