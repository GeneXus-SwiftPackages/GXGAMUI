...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAMUI",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAMUI-1.0.0-beta+20230524184838.xcframework.zip",
			checksum: "d4f5a2ae72162fd0eb4c6ecbe0ba886a11a8025bcbf1d8e614d57ad59c149f4b"
		)
	]
)