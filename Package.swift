...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAMUI",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAMUI-1.0.0-beta+20230309100338.xcframework.zip",
			checksum: "c8909e55a960d423d4e4f1e4045b266dbdfb35936bb3bc2348628f9e384f1dd0"
		)
	]
)