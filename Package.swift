...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXGAM.git", exact: "1.0.0-beta.20230706155940"),
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAMUI",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAMUI-1.0.0-beta.20230706155940.xcframework.zip",
			checksum: "1908697b64acffbd3c1b7c40332f9b96d0d9355ac78f67721bee952360034b48"
		)
	]
)