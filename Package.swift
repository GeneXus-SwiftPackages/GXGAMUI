...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAMUI",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAMUI-1.0.0-beta+20230605162159.xcframework.zip",
			checksum: "9b9eb6a8843ec0a8966c5f02926b9fcd4cbdc7ee255e0c2e04cd480ca164c455"
		)
	]
)