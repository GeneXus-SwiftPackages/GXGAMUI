...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAMUI",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAMUI-1.0.0-beta+20230428202437.xcframework.zip",
			checksum: "ea63f47448a848e7f70d4a97477dfd8aeef01a82e5e3b742beecc0bdb3a2dd10"
		)
	]
)