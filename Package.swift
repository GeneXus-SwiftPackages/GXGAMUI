...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAMUI",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAMUI-1.0.0-beta+20230324150340.xcframework.zip",
			checksum: "f30dd2b2d8eb8695c7ce1df7381f5c4b9d873179fe3d3c75163f0c21831dfdce"
		)
	]
)