...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAMUI",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAMUI-1.0.0-beta+20230509112137.xcframework.zip",
			checksum: "700d14a6e7a43d29f62404c5e8007af04d1114862eab15ca0450c36739a19d66"
		)
	]
)