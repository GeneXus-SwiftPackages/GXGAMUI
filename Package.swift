...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAMUI",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAMUI-1.0.0-beta+20230606141441.xcframework.zip",
			checksum: "b9bcbfc3af14ecc9896523d1a5f78fb3fc043a1a9297c35c63bcd5e5cf3ca6cf"
		)
	]
)