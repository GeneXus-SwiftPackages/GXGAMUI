...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAMUI",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAMUI-1.0.0-beta+20230411173940.xcframework.zip",
			checksum: "066e077273c63049413f4aa28a4fb2d3dd9b1c8b58461a58e4aab1876860056f"
		)
	]
)