...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAMUI",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAMUI-1.0.0-beta+20230228111720.xcframework.zip",
			checksum: "e4237a36c63167be684fe9b3ed61ff3e259316101ae93de8da24cc5b418de3a4"
		)
	]
)