...
let package = Package(
	...
	dependencies: [
		...
		.package(url: "https://github.com/GeneXus-SwiftPackages/GXGAM.git", exact: "1.2.0-beta.1"),
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAMUI",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAMUI-1.2.0-beta.1.xcframework.zip",
			checksum: "f2d4af39f717912e9f80c80acdfefadbae61a538dd162eff171ad60bb91f07a2"
		)
	]
)