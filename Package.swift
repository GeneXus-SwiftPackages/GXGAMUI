...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAMUI",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAMUI-1.0.0-beta+20230428153652.xcframework.zip",
			checksum: "7f63d588c579360a3abbf931ac3cfd8d6dcba1e591306e6b21a614155846f44e"
		)
	]
)