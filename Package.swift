...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAMUI",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAMUI-1.0.0-beta+20230314121632.xcframework.zip",
			checksum: "7b72c7684b79f457cef883e6446727c3839c0c9365d1932f6d67bde008dd5f7b"
		)
	]
)