...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAMUI",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAMUI-1.0.0-beta+20230606172938.xcframework.zip",
			checksum: "c0c4b6253ed5112e1892d0573434dd4078b57d502ddaefd9023dd9de3c59408d"
		)
	]
)