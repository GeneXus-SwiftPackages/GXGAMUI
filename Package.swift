...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAMUI",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAMUI-1.0.0-beta+20230509173316.xcframework.zip",
			checksum: "e6d6f7aec9b60ad27e99c81c0a3173a54211bc7c15f7f8843e814c6b3bc3ba5b"
		)
	]
)