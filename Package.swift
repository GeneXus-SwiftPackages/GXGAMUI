...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAMUI",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAMUI-1.0.0-beta+20230525122919.xcframework.zip",
			checksum: "338d1b9e9182b313522ac3e8956ac164ea6cd8ce78dcaa4ac018b1ceb2968825"
		)
	]
)