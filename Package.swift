...
let package = Package(
	...
	targets: [
		...
		.binaryTarget(
			name: "GXGAMUI",
			url: "https://pkgs.genexus.dev/iOS/beta/GXGAMUI-1.0.0-beta+20230321182636.xcframework.zip",
			checksum: "bf3f2f7400bc49cbc22851117b01bec5cf7acc7d01612b24a71da280df526129"
		)
	]
)